package com.tc2r.javatemplate.ui.score;
...
public class ScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // UI Variables
        android.widget.TextView totalQuestionsTV = findViewById(R.id.numofquestions_tv);
        android.widget.TextView commentTV = findViewById(R.id.comment_tv);
        android.widget.TextView totalCorrectTV = findViewById(R.id.numcorrect_tv);
        android.widget.TextView finalGradeTV = findViewById(R.id.finalgrade_tv);
