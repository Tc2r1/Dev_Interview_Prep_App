...
class ScoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        totalQuestionsTV = findViewById<TextView>(R.id.numofquestions_tv)
        commentTV = findViewById<TextView>(R.id.comment_tv)
        totalCorrectTV = findViewById<TextView>(R.id.numcorrect_tv)
        finalGradeTV = findViewById<TextView>(R.id.finalgrade_tv)
