package com.dreams.androidquizapp.ui.questions;
...
import com.dreams.androidquizapp.ui.main.MainActivity;
...
public class QuestionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        questionTV = mView.findViewById(com.dreams.androidquizapp.R.id.question);
        answerA = mView.findViewById(com.dreams.androidquizapp.R.id.answer_a_summary);
        detailsA = mView.findViewById(com.dreams.androidquizapp.R.id.answer_a_details);
        answerB = mView.findViewById(com.dreams.androidquizapp.R.id.answer_b_summary);
        detailsB = mView.findViewById(com.dreams.androidquizapp.R.id.answer_b_details);
        answerC = mView.findViewById(com.dreams.androidquizapp.R.id.answer_c_summary);
        detailsC = mView.findViewById(com.dreams.androidquizapp.R.id.answer_c_details);
        answerD = mView.findViewById(com.dreams.androidquizapp.R.id.answer_d_summary);
        detailsD = mView.findViewById(com.dreams.androidquizapp.R.id.answer_d_details);
        nextBtn = mView.findViewById(com.dreams.androidquizapp.R.id.nextBtn);
        newBtn = mView.findViewById(com.dreams.androidquizapp.R.id.newQuizBtn);
