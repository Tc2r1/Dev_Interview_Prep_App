package com.dreams.androidquizapp.ui.score;
...
public class ScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // UI Variables
        android.widget.TextView totalQuestionsTV = findViewById(com.dreams.androidquizapp.R.id.numofquestions_tv);
        android.widget.TextView commentTV = findViewById(com.dreams.androidquizapp.R.id.comment_tv);
        android.widget.TextView totalCorrectTV = findViewById(com.dreams.androidquizapp.R.id.numcorrect_tv);
        android.widget.TextView finalGradeTV = findViewById(com.dreams.androidquizapp.R.id.finalgrade_tv);
